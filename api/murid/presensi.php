...
try{ $filters=$_GET; $filters['murid_id']=(int)$murid['id']; successResponse('Presensi pribadi berhasil dimuat.', Presensi::all($db,$filters)); }catch(Throwable $e){ errorResponse('Presensi gagal dimuat.',500); }
